...
namespace OneRSS.Data.DataSchemas
{
    ...
    /// </summary>
    public class RssSchema : SchemaBase, IEquatable<RssSchema>, IComparable<RssSchema>, ISyncItem<RssSchema>
    {
        ...
        public string ExtraImageUrl
        {
            ...
            set { Set(ref _extraImageUrl, value); }
        }

        public string MediaUrl
        {
            get { return _mediaUrl; }
            set { Set(ref _mediaUrl, value); }
        }

        public string FeedUrl
        {
            get { return _feedUrl; }
            set { Set(ref _feedUrl, value); }
        }
