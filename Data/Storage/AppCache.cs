...
namespace OneRSS.Data.Storage
{
    public class AppCache
    {
        ...
        public static async Task<DataSourceContent<T>> GetItemsAsync<T>(string key) where T : class
        {
            string json = null;
        ...
        public static async Task AddItemsAsync<T>(string key, DataSourceContent<T> data) where T : class
        {
            try
            {
